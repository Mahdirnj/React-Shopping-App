function DataAnalystSVG({PhotoInside}) {
    return (
        <div>
            <div
                ...
                <div className="rounded-lg overflow-hidden h-[156px] md:h-[278px] bg-white dark:bg-gray-800">
                    ...
                    {/*     className="dark:hidden h-[156px] md:h-[278px] w-full rounded-xl" alt=""/>*/}
                    <img src={PhotoInside}
                         className="hidden scale-y-110 scale-x-105 dark:block h-[156px] md:h-[278px] w-full rounded-lg"
                         alt=""/>
                </div>
            </div>
            <div
                ...
                <div
                    className="absolute left-1/2 top-0 -translate-x-1/2 rounded-b-xl w-[56px] h-[5px] md:w-[96px] md:h-[8px] bg-gray-800"></div>
            </div>
